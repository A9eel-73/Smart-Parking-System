...
class _ParkingDashboardState extends State<ParkingDashboard> {
  ...
  final DatabaseReference _zonesRef = FirebaseDatabase.instance.ref(
    'parking_zones',
  );
  ...
  void _navigateToParking(String selection) {
    ...
    if (_parkingCoordinatesMap.containsKey(selection)) {
      ...
      Future.delayed(const Duration(milliseconds: 300), () {
        ...
        if (selection.contains('Zone A') ||
            selection.contains('Testing Site')) {
  ...
  Widget _buildMapPage(Color cardBg, Color textColor) {
    ...
    LatLng pinA =
        _parkingCoordinatesMap['Testing Site (Zone A)'] ?? _defaultLocation;
    LatLng pinB =
        _parkingCoordinatesMap['Science Parking (Zone B)'] ??
        const LatLng(21.497288, 39.244564);
                ...
                markers: [
                  Marker(
                    ...
                    child: GestureDetector(
                      onTap: () => _showParkingDetailsBottomSheet(
                        context,
                        "Testing Site (Zone A)",
                        cardBg,
                        textColor,
                  ...
                  Marker(
                    ...
                    child: GestureDetector(
                      onTap: () =>
                          _showComingSoonToast("Science Parking (Zone B)"),
                      ...
                      (BuildContext context, SearchController controller) {
                        ...
                        return _parkingOptions
                            ...
                            .map((String option) {
                              return ListTile(
                                leading: Icon(
                                  option.contains('Testing')
                                      ? Icons.stars_rounded
                                      : Icons.lock_clock_rounded,
                                  color: option.contains('Testing')
                                      ? Colors.cyanAccent
                                      : Colors.grey,
                                ),
                                title: Text(
  ...
  String _getPageTitle() {
    switch (_currentIndex) {
      case 1:
        return "Bookings Center";
      case 2:
        return "History Logs";
      case 3:
        return "User Profile";
      case 4:
        return "Logo Control Center";
      default:
        return "Feature";
    }
  }
  ...
  void _showParkingDetailsBottomSheet(
        ...
        return FractionallySizedBox(
          ...
          child: StatefulBuilder(
            builder: (BuildContext context, StateSetter setModalState) {
              ...
              double occupancyRate = totalCalculated > 0
                  ? (occupiedSlots / totalCalculated) * 100
                  : 0;
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            "$availableSlots / $totalCalculated Available",
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Icon(
            isEmpty ? Icons.lock_open : Icons.lock,
            size: 16,
            color: isEmpty ? Colors.green : Colors.red,
          ),
        ],
